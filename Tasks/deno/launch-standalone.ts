...
{
    await $`${__root_directory}/builds/vs2022/ReactInstrument/ReactInstrument_artefacts/Release/Standalone/ReactInstrument.exe`;
}
...
{
    await $`${__root_directory}/builds/ninja-single-release/ReactInstrument/ReactInstrument_artefacts/Release/Standalone/ReactInstrument`;
}